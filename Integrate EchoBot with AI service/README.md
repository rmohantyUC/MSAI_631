...
# MSAI_631
8710a618e410ba0bae859859906352cdc5ef3928

# Sentiment Analysis Echo Bot

## Overview
This project extends the functionality of the echo bot from previous project by incorporating sentiment analysis. The original echo bot allows users to input text, which is then echoed back to them. With the addition of sentiment analysis, the bot can now analyze the sentiment of the input text and provide feedback accordingly.

## Files Origin
The code files included in this project are adapted from the echo bot project. We are copying and modifying these files to add sentiment analysis functionality to the bot.
